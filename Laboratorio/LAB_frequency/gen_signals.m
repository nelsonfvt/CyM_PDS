...
Ac_y = 0.1*randn(10000,1);
Ac_z = 9.8 + 0.1*randn(10000,1);
...
Ac_x = 0.2*randn(1,10000);
Ac_y = 0.2*randn(1,10000);
Ac_z = 0.2*randn(1,10000);
...
csvwrite('motion.csv',[Ac_x' Ac_y' Ac_z'+5 Gy_x' Gy_y' Gy_z']);